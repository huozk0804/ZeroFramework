...
namespace ZeroFramework.Editor
{
    ...
    public static class LogScriptingDefineSymbols
    {
        ...
        /// 禁用所有日志脚本宏定义。
        /// </summary>
        [MenuItem(EditorConst.BaseMainPath + "Log Scripting Define Symbols/Disable All Logs", false, priority = EditorConst.MenuPriority_Base)]
        ...
        /// 开启所有日志脚本宏定义。
        /// </summary>
        [MenuItem(EditorConst.BaseMainPath + "Log Scripting Define Symbols/Enable All Logs", false, priority = EditorConst.MenuPriority_Base)]
        ...
        /// 开启调试及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem(EditorConst.BaseMainPath + "Log Scripting Define Symbols/Enable Debug And Above Logs", false, priority = EditorConst.MenuPriority_Base)]
        ...
        /// 开启信息及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem(EditorConst.BaseMainPath + "Log Scripting Define Symbols/Enable Info And Above Logs", false, priority = EditorConst.MenuPriority_Base)]
        ...
        /// 开启警告及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem(EditorConst.BaseMainPath + "Log Scripting Define Symbols/Enable Warning And Above Logs", false, priority = EditorConst.MenuPriority_Base)]
        ...
        /// 开启错误及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem(EditorConst.BaseMainPath + "Log Scripting Define Symbols/Enable Error And Above Logs", false, priority = EditorConst.MenuPriority_Base)]
        ...
        /// 开启严重错误及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem(EditorConst.BaseMainPath + "Log Scripting Define Symbols/Enable Fatal And Above Logs", false, priority = EditorConst.MenuPriority_Base)]
