...
namespace ZeroFramework
{
    public static partial class Utility
    {
        ...
        public static class Folder
        {
            ...
            /// <returns>操作成功。</returns>
            public static bool CopyFilesToRootPath(string sourceRootPath, string destRootPath,
            ...
            /// <returns>操作成功。</returns>
            public static bool CopyFiles(string sourceRootPath, string destRootPath,
                SearchOption searchOption = SearchOption.AllDirectories)
            {
                string[] fileNames = Directory.GetFiles(sourceRootPath, "*", searchOption);
                foreach (string fileName in fileNames)
