        ...
        public override void OnInspectorGUI()
        {
            ...
            if (EditorApplication.isPlaying)
            {
                ...
                if (Zero.HasModule<ConfigManager>())
                {
                    ...
                    EditorGUILayout.LabelField("Cached Bytes Size", Zero.config.CachedBytesSize.ToString());
                }
                ...
                if (Zero.HasModule<DataNodeManager>())
                {
                    ...
                    DrawDataNode(Zero.dataNode.Root);
                }
                ...
                if (Zero.HasModule<UIManager>())
                {
                    ...
                    EditorGUILayout.LabelField("UI Group Count", Zero.ui.UIGroupCount.ToString());
                }
