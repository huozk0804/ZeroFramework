...
namespace ZeroFramework.FileSystem
{
    ...
    public sealed class FileSystemManager : GameFrameworkModule, IFileSystemManager
    {
        ...
        public FileSystemManager()
        {
            ...
            var name = GameFrameworkConfig.Instance.m_FileSystemHelperTypeName;
            var baseHelper = GameFrameworkConfig.Instance.m_CustomFileSystemHelper;
            FileSystemHelperBase fileSystemHelper = Helper.CreateHelper(name, baseHelper);
            if (fileSystemHelper == null)
            {
                Log.Error("Can not create fileSystem helper.");
                return;
            }
            SetFileSystemHelper(fileSystemHelper);
        }
