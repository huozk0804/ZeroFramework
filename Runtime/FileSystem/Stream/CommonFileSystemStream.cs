...
namespace ZeroFramework.FileSystem
{
    ...
    public sealed class CommonFileSystemStream : FileSystemStream, IDisposable
    {
        ...
        /// 获取文件系统流长度。
        /// </summary>
        internal override long Length => m_FileStream.Length;

        /// <summary>
        /// 设置文件系统流长度。
        /// </summary>
        /// <param name="length">要设置的文件系统流的长度。</param>
        internal override void SetLength(long length)
        {
        ...
        internal override void Seek(long offset, SeekOrigin origin)
        {
        ...
        internal override int Read(byte[] buffer, int startIndex, int length)
        {
        ...
        internal override void Write(byte[] buffer, int startIndex, int length)
        {
