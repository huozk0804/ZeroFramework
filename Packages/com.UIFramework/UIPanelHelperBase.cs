...
namespace ZeroFramework.UI
{
    ...
    /// 界面辅助器基类。
    /// </summary>
    public abstract class UIPanelHelperBase : MonoBehaviour, IUIPanelHelper
    {
        /// <summary>
        /// 实例化界面。
        /// </summary>
        ...
        /// <returns>界面。</returns>
        public abstract IUIPanel CreateUIForm(object uiFormInstance, IUIGroup uiGroup, object userData);
