...
namespace ZeroFramework
{
	...
	public sealed class Timer
	{
		...
		public static Timer Register (float duration, System.Action onComplete, Action<float> onUpdate = null,
			bool isLooped = false, bool useRealTime = false, MonoBehaviour autoDestroyOwner = null) {
			// create a manager object to update all the timers if one does not already exist.
			if (Timer._manager == null) {
				Timer._manager = Zero.timer;
			}
		...
		private Timer (float duration, System.Action onComplete, Action<float> onUpdate,
