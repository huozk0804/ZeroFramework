...
namespace ZeroFramework.Editor.Package
{
    static internal class LoopScrollRectMenuOptions
    {
        ...
        [MenuItem(EditorConst.BaseGameObjectPath + "Loop Horizontal Scroll Rect", false, 2151)]
        ...
        [MenuItem(EditorConst.BaseGameObjectPath + "Loop Vertical Scroll Rect", false, 2152)]
