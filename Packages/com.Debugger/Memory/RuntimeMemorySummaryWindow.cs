    ...
    internal sealed partial class RuntimeMemorySummaryWindow : ScrollableDebuggerWindowBase
    {
        ...
        protected override void OnDrawScrollableWindow()
        {
            ...
            GUILayout.BeginVertical("box");
            {
                ...
                {
                    GUILayout.Label(Utility.Text.Format("<b>{0} Objects ({1}) obtained at {2:yyyy-MM-dd HH:mm:ss}.</b>",
                        _sampleCount, GetByteLengthString(_sampleSize), _sampleTime.ToLocalTime()));
